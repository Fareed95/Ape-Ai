...
export default function OrgSettings() {
  ...
  const getFullLogoUrl = (logoPath: string) => {
    ...
    return `https://api-ape.crodlin.in${logoPath}`;
  };
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      const response = await fetch(`https://api-ape.crodlin.in/api/companies/${companyId}/`, {
        method: 'PATCH',
        headers: {
          "Authorization": token,
          'Content-Type': 'application/json',
      ...
      if (formData.logo) {
        ...
        const logoResponse = await fetch(`https://api-ape.crodlin.in/api/companies/${companyId}/`, {
          method: 'PATCH',
          headers: {
            "Authorization": token,
          },
