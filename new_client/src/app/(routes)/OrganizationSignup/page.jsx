...
function OrganizationSignup() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://api-ape.crodlin.in/api/register', {
        method: 'POST',
        headers: {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-neutral-900 to-black p-4 sm:p-6 md:p-8">
      ...
      <div className="w-full max-w-md relative z-10">
        <motion.div
          ...
          className="relative"
        >
          {/* Card backdrop blur and glow effects */}
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-3">
                <LabelInputContainer className="space-y-1 sm:space-y-1.5">
                  <Label htmlFor="firstname" className="text-neutral-300 text-xs sm:text-sm">Organization Name</Label>
                  <Input
                    id="firstname"
                ...
                <LabelInputContainer className="space-y-1 sm:space-y-1.5">
                  <Label htmlFor="lastname" className="text-neutral-300 text-xs sm:text-sm">Type</Label>
                  <Input
                    id="lastname"
              ...
              >
                {loading ? (
                  ...
                  <span className="relative z-10">Create Organization Account</span>
                )}
                <div className="absolute top-0 -inset-full h-full w-1/2 z-5 block transform -skew-x-12 bg-gradient-to-r from-transparent to-white opacity-10 group-hover:animate-shine" />
                <BottomGradient />
              </motion.button>

              {/* Login Link - responsive text sizing */}
