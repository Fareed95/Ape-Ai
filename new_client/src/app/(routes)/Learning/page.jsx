...
export default function Home() {
  ...
  useEffect(() => {
    if (contextRoadmap != '') {
      toast({
        ...
        description: "Your roadmap has been successfully generated",
        variant: "default",
  ...
  const handleNextComponent = async () => {
   ...
   if (currentComponentIndex + 1 < total && contextRoadmap!= '') {
      ...
      toast({
        ...
        description: "Your full roadmap has not been generated yet",
        variant: "destructive",
  ...
  const renderMainContent = (componentObject) => {
