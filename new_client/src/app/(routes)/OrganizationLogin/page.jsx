...
function OrganizationLogin() {
  ...
  const Getuserinfo = async () => {
    ...
    try {
      const response = await fetch('https://api-ape.crodlin.in/api/user', {
        method: 'GET',
        headers: {
          "Authorization": token,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://api-ape.crodlin.in/api/login', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const OAuth = async () => {
    try {
      const response = await fetch('https://api-ape.crodlin.in/api/oauth2/login/', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-neutral-900 to-black p-4 sm:p-6 md:p-8">
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-[250px] sm:w-[300px] h-[250px] sm:h-[300px] bg-ai-blue-500/20 rounded-full blur-[100px] sm:blur-[120px] animate-pulse-subtle" />
        <div className="absolute bottom-0 right-0 w-[250px] sm:w-[300px] h-[250px] sm:h-[300px] bg-ai-teal-500/20 rounded-full blur-[100px] sm:blur-[120px] animate-pulse-subtle" />
      ...
      <div className="w-full max-w-md relative z-10">
        <motion.div
          ...
          className="relative"
        >
          {/* Card backdrop blur and glow effects - enhanced for responsive display */}
          ...
          <div className="bg-neutral-900/80 backdrop-blur-xl rounded-2xl border border-neutral-800/60 shadow-2xl p-5 sm:p-6 md:p-8 relative overflow-hidden">
            ...
            {/* Header - improved responsive font sizing */}
            ...
            {/* User Button - responsive button sizing */}
            <motion.div variants={itemVariants}>
              <Link href="/Login">
                <button className="w-full py-2 sm:py-2.5 px-3 sm:px-4 mb-5 sm:mb-6 bg-gradient-to-r from-ai-blue-600/60 to-ai-teal-700/60 hover:from-ai-blue-600 hover:to-ai-teal-700 text-white rounded-lg text-xs sm:text-sm font-medium transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-ai-blue-600/10 relative overflow-hidden group">
                  <span className="relative z-10">Continue as User</span>
                  {/* Button shine effect */}
            ...
            {/* Login Form - improved responsive spacing */}
            <motion.form 
            ...
            >
              <LabelInputContainer className="space-y-1 sm:space-y-1.5">
                <Label htmlFor="email" className="text-neutral-300 text-xs sm:text-sm">Organization Email</Label>
              ...
              {/* Login Button & Forgot Password - responsive sizing */}
              ...
              {/* Signup Link - responsive text sizing */}
              ...
              {/* Social Logins - responsive sizing */}
