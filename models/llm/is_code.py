...
def is_code(input_value):
    ...
    json_file = os.path.join(json_dir, "Is_code_Checking.json")
    ...
    return json_message['is_coding']


if __name__=='__main__':
    input_value = "Drafting in laws"
    print(is_code(input_value))  
