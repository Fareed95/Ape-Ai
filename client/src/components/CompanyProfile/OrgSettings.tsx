...
export default function OrgSettings() {
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      const response = await apeService.updateCompany(token, companyId as number, requestData);
      if (!response) {
      ...
      if (formData.logo) {
        ...
        const updatedCompany = await apeService.uploadCompanyLogo(token, companyId as number, formData.logo);
